program neural_vibrator
  ...
  real(8),parameter:: weight_plus=0.2, weight_minus=-1.19
  real(8),parameter:: adjusting_constant=0.0001,oscillator_period=0.01
  ...
  real(8):: next_fire_time,printing_array(num+1),vibrating,adjuster
...
!             call firing_time_updater(neural_network,firing_table,next_fire_time,diff_central)
            ! next_fire_time=dummy_time
            ! adjuster=adjuster+adjusting_constant
          end if
       end do
       call firing_time_updater(neural_network,firing_table,next_fire_time,diff_central)
